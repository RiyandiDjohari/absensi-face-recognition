...
const Logo = ({ sidebarMini, isMobile }) => {
  return (
    <header className={`py-2 flex ${sidebarMini ? "justify-center" : "justify-start items-center gap-3"} border-b-2 border-[#7076FE]`}>
      ...
      {!sidebarMini && <h1 className='font-semibold'>Dinas Kebudayaan dan Pariwisata</h1>}
      {isMobile && <h1 className='font-semibold'>Dinas Kebudayaan dan Pariwisata</h1>}
    </header>
  )
}
